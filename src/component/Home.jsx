  ...
  return (
      ...
      <div className="relative z-10 max-w-screen-xl px-4 pb-20 pt-5 sm:pt-10 sm:py-24 mx-auto sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col sm:flex-row items-center sm:items-start justify-between space-y-8 sm:space-y-0">
          ...
          <div className="flex-none">
            <img
              className={`w-106 h-auto transition-all duration-300 rounded-lg cursor-pointer filter grayscale hover:grayscale-0 ${
                isScrolled ? "animate-colorChange" : ""
              }`}
              src={constimg}
              alt="image1"
            />
        ...
        <div className="text-center sm:text-right mt-8 sm:ml-auto">
          <h2 className="text-4xl font-bold sm:text-5xl">
            Start Learning
            <span className="animate-bounce hidden sm:block text-4xl">
    ...
    <div className="container m-auto px-6 text-gray-600 md:px-12 xl:px-6">
          <div className="space-y-1 md:space-y-0 md:flex md:gap-6 lg:items-start lg:gap-4 ">
              <img
              className={`md:7/12 lg:w-6/12 mx-1 transition-all duration-300 rounded-lg cursor-pointer filter grayscale hover:grayscale-0  ${
                isScrolled ? "animate-colorChange" : ""
              }`}
